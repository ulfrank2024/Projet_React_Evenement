  ...
  <div className="md:p-10">
   <div className="flex flex-wrap justify-center gap-4 overflow-x-auto py-2">
    {Object.keys(data.categories).map((key) => (
     ...
     >
      {t(`categories.${key}.nom`, data.categories[key].nom)}
     </button>
    ))}
   </div>
   ...
   <div className="border-t mt-4 p-4">
      ...
      return (
       ...
       >
        ...
        <p className="text-sm w-30">
         {t(
          `categories.${selectedCategory}.articles_en_vedette.${item.id}.titre`,
          item.titre
         )}
        </p>
       </li>
    ...
    <h1 className="text-xl font-bold mt-20 mb-4">
     {t('aide.naviguer_par_theme')}
    </h1>
      ...
      return (
       ...
       >
        ...
        <p className="text-sm text-center">
         {t(
          `categories.${selectedCategory}.naviguer_par_theme.${item.id}.titre`,
          item.titre
         )}
        </p>
       </li>
